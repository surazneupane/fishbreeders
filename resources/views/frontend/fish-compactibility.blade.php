        ...
        <div class="col-lg-6 p-2 mx-auto ">
            ...
            <div class="my-5 w-100">
                ...
                <div class="table-responsive">
                    ...
                    <table class="table table-striped  table-hover " style="style:100%;overflow-x:scroll">
                        <thead>
                            <tr>
                                <th scope="col" style="position: sticky; left:0;  background: #fff !important;"></th>
                        ...
                        <tbody>
                            @foreach ($fishes as $fish )
                            <tr>
                                <th scope="row " style="position: sticky; left:0;  background: #fff !important; ">
                                    <small>
                                        {{ $fish->name }}
                                    </small>
                                </th>
