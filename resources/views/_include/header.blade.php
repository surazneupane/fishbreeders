<header>
    ...
    <div class="bg-primary">
        <div class="container d-flex justify-content-between">
            ...
            <ul class="nav">
                <li class="nav-item">
                    <a href="{{ route('forums') }}" class="nav-link text-capatlize text-white h-100 nav-hover">Forum</a>
                </li>

                @if(Auth::user())
                <li class="nav-item">
                    <div class="dropdown">
                        <button class="btn btn-transparent text-white dropdown-toggle shadow-none nav-hover"
                ...
                <li class="nav-item">
                    <div class="dropdown">
                        <button class="btn btn-transparent dropdown-toggle shadow-none text-white nav-hover"
