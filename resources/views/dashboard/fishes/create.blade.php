                            ...
                            <div class="shadow overflow-hidden sm:rounded-md">
                                <div class="px-4 py-5 bg-white sm:p-6">
                                    <div class="grid grid-cols-6 gap-6">
                                        ...
                                        <div class="text-green-900 bg-green-200 px-3 col-span-6 py-2">{{Session::get('success')}}</div>

                                        @endif

                                        <div class="col-span-6 sm:col-span-6">
                                            <label for="title" class="block text-sm font-medium text-gray-700">{{ _('Fish Name*') }}</label>
