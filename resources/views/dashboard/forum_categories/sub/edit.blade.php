                ...
                <div class="md:grid md:grid-cols-3 md:gap-6">
                    <div class="md:col-span-1">
                        <div class="px-4 sm:px-0">
                            <h3 class="text-lg font-medium leading-6 text-gray-900">{{ _('Edit Forum Sub Category') }}</h3>
                    ...
                    <div class="mt-5 md:mt-0 md:col-span-2">
                     ...
                     <p style="color: green">   {{Session::get('success')}} </p>
                        @endif
                        <form action="{{ route('forumcategory.subcategory.update', $category->id) }}" method="POST">
                            @csrf
                            @method('POST')
                            ...
                            <div class="px-4 py-3 bg-gray-50 flex justify-between sm:px-6">
                                <a href="{{ route('forumcategory.show',$category->parent_id) }}"
