<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            {{ $forumCategory->title }} - {{ __('Create New Sub-Category') }}
        </h2>
    </x-slot>
                ...
                <div class="md:grid md:grid-cols-3 md:gap-6">
                    <div class="md:col-span-1">
                        <div class="px-4 sm:px-0">
                           ...
                           Create Sub Category For :<strong> {{$forumCategory->title}} </strong>
                            </p>
                        </div>
                    </div>
                    <div class="mt-5 md:mt-0 md:col-span-2">
                        <form action="{{ route('forumcategory.subcategory.store', $forumCategory->id) }}" method="POST">
                            @csrf
