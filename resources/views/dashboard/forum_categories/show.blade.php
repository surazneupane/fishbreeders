    ...
    <x-slot name="header">
        <div class="flex justify-between items-center">
            ...
            <h2 class="font-semibold text-xl text-gray-800 leading-tight ">
                {{ $forumCategory->title}} {{ __(' - SubCategories List') }}
            </h2>
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="block mb-8">
                <a href="{{ route('forumcategory.subcategory.create', $forumCategory->id) }}"
                        ...
                        <div class="shadow overflow-hidden border-b border-gray-200 sm:rounded-lg">
                            <table class="min-w-full divide-y divide-gray-200">
                                ...
                                <tbody class="bg-white divide-y divide-gray-200">
                                    @foreach ($forumCategory->children as $child)
                                    <tr>
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium ">
                                            ...
                                            <a href="{{ route('forumcategory.subcategory.edit', $child->id) }}"
                                                class="text-indigo-600 m-1 hover:text-indigo-900">Edit</a>
                                            <form action="{{ route('forumcategory.destroy', $child->id) }}" class="inline"
                                                method="post"
