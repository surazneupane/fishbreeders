                                ...
                                <div class="px-4 py-5 bg-white sm:p-6">
                                    <div class="grid grid-cols-6 gap-6">
                                        <div class="col-span-6 sm:col-span-6">
                                            <label for="title"
                                                class="block text-sm font-medium text-gray-700">{{ _('Post Title*') }}</label>
                                        ...
                                        <div class="col-span-6 sm:col-span-6">
                                            <label for="featured_image"
                                                class="block text-sm font-medium text-gray-700">{{ _('Featured Image*') }}</label>
                                        ...
                                        <div class="col-span-6 sm:col-span-6">
                                            <label for="excerpt"
                                                class="block text-sm font-medium text-gray-700">{{ _('Excerpt*') }}</label>
                                        ...
                                        <div class="col-span-6 sm:col-span-6">
                                            <label for="content"
                                                class="block text-sm font-medium text-gray-700">{{ _('Post Content*') }}
                                                @error('content')
                                                <span class="text-sm text-red-500">
                                                    {{ $message }}
                                                </span>
